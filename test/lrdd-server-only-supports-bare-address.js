    ...
    describe("When an HTTP service just supports host-meta with XRD", function() {
        before(function() {
            ...
            nock("http://localhost")
                ...
                .reply(200, "<?xml version='1.0' encoding='UTF-8'?>\n<XRD xmlns='http://docs.oasis-open.org/ns/xri/xrd-1.0'>\n<Subject>alice@localhost</Subject><Link rel='profile' href='http://localhost/profile/alice' /></XRD>", {"Content-Type": "application/xrd+xml"});
        });
        ...
        describe("and we get a webfinger's metadata", function() {
            ...
            before(async function() {
                jrd = await wf.webfinger("acct:alice@localhost");
            }, {timeout: 10000});
