...
const invalidHostname = function (hostname) {
  const examples = ['example.com', 'example.org', 'example.net']
  const tlds = ['example', 'invalid']
  let parts
...
const webfinger = async function (resource, rel = null, options = {}) {
  let hostname
